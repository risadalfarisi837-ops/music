      ...
      <div className="px-6 pt-6">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            <h2 className="text-2xl font-bold text-white">RISYADH</h2>
          ...
          <div className="grid grid-cols-4 gap-3 w-full max-w-sm mb-4">
            <a href="https://lynk.id/risyadh" className="flex flex-col items-center justify-center gap-2 bg-[#1C1C1E] hover:bg-[#2C2C2E] p-4 rounded-2xl transition-colors">
              <Globe className="w-6 h-6 text-white" />
              <span className="text-[10px] text-white/70 font-medium">Website</span>
            </a>
            <a href="https://whatsapp.com/channel/0029Vb7Wq8jDjiOVgAqk1f1v" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center gap-2 bg-[#1C1C1E] hover:bg-[#2C2C2E] p-4 rounded-2xl transition-colors">
            ...
            <a href="https://www.instagram.com/risyadhid1_23?igsh=cHdlOHFhaWwwM2xh" className="flex flex-col items-center justify-center gap-2 bg-[#1C1C1E] hover:bg-[#2C2C2E] p-4 rounded-2xl transition-colors">
